...
public class RegisterActivity extends Activity {
    ...
    /**
     * Keep track of the userid on successful login. Null if login fails.
     */
    private String user = null;
    /**
     * Keep track of when the app is waiting for an async call.
     */
...
//    }
    ...
    public class UserRegisterTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            wait = true;
            wait = true;
            ref.createUser(mEmail.toLowerCase(), mPassword, new Firebase.ValueResultHandler<Map<String, Object>>() {
                @Override
                public void onSuccess(Map<String, Object> result) {
                    user = result.get("uid").toString();
                    wait = false;
                }
